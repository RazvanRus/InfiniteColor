...
class GameService {
    ...
    func getHighscore() -> Int {
        return UserDefaults.standard.integer(forKey: "RusRazvan.InfiniteColor.highscore")
    }
    ...
    func getBonusPoints() -> Int {
        return UserDefaults.standard.integer(forKey: "RusRazvan.InfiniteColor.bonuspoints")
    }
}
