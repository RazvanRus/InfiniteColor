...
class OctogonService {
    ...
    func set(allParts parts: [(String,Bool)]) {
        UserDefaults.standard.set(parts, forKey: "RusRazvan.InfiniteColor.allparts")
        UserDefaults.standard.synchronize()
    }
    func getAllParts() -> [(String,Bool)] { return UserDefaults.standard.array(forKey: "RusRazvan.InfiniteColor.allparts") as! [(String, Bool)] }
    
    func set(currentParts parts: [String]) {
        UserDefaults.standard.set(parts, forKey: "RusRazvan.InfiniteColor.currentparts")
        UserDefaults.standard.synchronize()
    }
    func getCurrentParts() -> [String] { return UserDefaults.standard.array(forKey: "RusRazvan.InfiniteColor.currentparts") as! [String] }
}
